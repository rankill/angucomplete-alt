...
| selectedReceivedField | Lets define what element will be pased to selectedObject attr |  No | @ | 'all' or undefined - 'title' - 'originalObject.id' or 'originalObject.name' [It depends of the returned element]|
