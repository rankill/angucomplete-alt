...
| close-input-on | Function that clean input search depneding of an external value |  No | = | true |
| close-on-select | Function that clean input search when the user select a value from de list of values |  No | = | true |
