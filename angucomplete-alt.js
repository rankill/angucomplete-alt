    ...
    function ($q, $parse, $http, $sce, $timeout, $templateCache, $interpolate, $compile) {
      ...
      function getElementRect( element){
        ...
        return {
          ...
          distanceToBottom: bodyRect.height - elementRect.bottom //Distance between the bottom input and the
                                                                 // bottom body
        };
      }
      ...
      function link(scope, elem, attrs, ctrl) {
        ...
        /**
         * Deep check to the element features to get all changes and adapt the current dropdown, not only with
         * the input parent, but also with the current page
         */
        scope.$watchCollection( function (  ) {
          return getElementRect(inputField[0]);
        }, function ( newVal ) {
